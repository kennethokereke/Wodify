    ...
    return (
      <Block>
        <Block center bottom flex={0.4}>
          <Text h1 center bold>
            Welcome to 
            <Text h1 primary> Wodify</Text>
          </Text>
          <Text caption gray2 style={{ marginTop: theme.sizes.padding / 2 }}>
           Enjoy Tracking performance, classes, and Tracking your diet
          </Text>
        </Block>
        <Block center middle>
        ...
        <Block middle flex={0.5} margin={[0, theme.sizes.padding * 2]}>
          ...
          <Button shadow onPress={() => navigation.navigate('Login')}>
            <Text center semibold>Next</Text>
          </Button>
...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../assets/images/welcome1.png') },
    { id: 2, source: require('../assets/images/welcome2.png') },
    { id: 3, source: require('../assets/images/welcome3.png') },
  ],
};
